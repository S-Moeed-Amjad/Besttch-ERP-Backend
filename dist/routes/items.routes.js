 ...
 */
router.get("/", auth_1.requireAuth, itemsController.list);
/**
 * @openapi
 * /items:
 *   post:
 ...
 */
router.post("/", auth_1.requireAuth, itemsController.create);
/**
 * @openapi
 ...
 */
router.get("/serial/:serialNumber", auth_1.requireAuth, itemsController.getBySerial);
/**
 * @openapi
 * /items/code/{itemCode}:
 *   get:
 ...
 *         description: Item not found
 */
router.get("/code/:itemCode", auth_1.requireAuth, itemsController.getByCode);
/**
 * @openapi
 * /items/{id}:
 *   get:
 ...
 *         description: Item not found
 */
router.get("/:id", auth_1.requireAuth, itemsController.getOne);
/**
 * @openapi
 * /items/{id}:
 *   put:
 ...
 *         description: Validation failed
 */
router.put("/:id", auth_1.requireAuth, itemsController.update);
/**
 * @openapi
 * /items/{id}/sell:
 *   post:
 ...
 */
router.post("/:id/sell", auth_1.requireAuth, itemsController.sell);
/**
 * @openapi
 * /items/{id}/remove:
 *   post:
 ...
 *         description: Item is not currently in stock
 */
router.post("/:id/remove", auth_1.requireAuth, itemsController.remove);
/**
 * @openapi
 * /items/{id}/return:
 *   post:
 ...
 */
router.post("/:id/return", auth_1.requireAuth, itemsController.returnItem);
